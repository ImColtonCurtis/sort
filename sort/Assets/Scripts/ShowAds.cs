...
namespace Unity.Services.Mediation.Samples
{
    public class ShowAds : MonoBehaviour
    {
        ...
        async void Start()
        {
            ...
            if ((PlayerPrefs.GetInt("PointsSinceLastAdPop", 0) >= 30 || (PlayerPrefs.GetInt("GamesSinceLastAdPop", 0) >= 2 && PlayerPrefs.GetInt("PointsSinceLastAdPop", 0) >= 1))
                && PlayerPrefs.GetInt("GameSinceLastAd", 0) >= 7)
            {
                // show pop-up
                poppedUp = true;
